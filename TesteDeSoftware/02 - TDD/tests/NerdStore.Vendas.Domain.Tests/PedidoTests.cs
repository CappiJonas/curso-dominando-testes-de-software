...
namespace NerdStore.Vendas.Domain.Tests
{
    public class PedidoTests
    {
        ...
        public void AdicionarItemPedido_ItemExistente_DeveIncrementarUnidadesSomarValores()
        {
            ...
            Assert.Equal(3, pedido.PedidoItems.First(p => p.ProdutoId == produtoId).Quantidade);
        }
        ...
        [Trait("Categoria", "Vendas - Pedido")]
        public void AtualizarItemPedido_ItemNaoExisteNaList_DeveRetornarException()
        {
            //
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
        ...
        [Trait("Categoria", "Vendas - Pedido")]
        public void AtualizarItemPedido_PedicoComProdutosDiferentes_DeveAtualizarValorTotal()
        {
            //Arrange
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
            var produtoId = Guid.NewGuid();
            var pedidoItemExistente1 = new PedidoItem(Guid.NewGuid(), "Produto Xpto", 2, 100);
            var pedidoItemExistente2 = new PedidoItem(produtoId, "Produto Testes", 3, 15);
        ...
        [Fact(DisplayName = "Atualizar Item Pedido Quantidde acima do permitido")]
        [Trait("Categoria", "Vendas - Pedido")]
        ...
        public void RemoverItemPedido_ItemExistente_DeveAtualizarValorTotal()
        {
            ...
            var pedidoItem2 = new PedidoItem(produtoId, "ProdutoTeste", 3, 15);
        ...
        public void AplicarVoucher_VoucherTipoValorDesconto_DeveDescontarDoValorTotal()
        {
            //Arrange
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
            var pedidoItem1 = new PedidoItem(Guid.NewGuid(), "ProdutoXpto", 2, 100);
            var pedidoItem2 = new PedidoItem(Guid.NewGuid(), "ProdutoTeste", 3, 15);
            pedido.AdicionarItem(pedidoItem1);
            pedido.AdicionarItem(pedidoItem2);
        ...
        public void AplicarVoucher_VoucherTipoPercentualDesconto_DeveDescontarDoValorTotal()
        {
            ...
            pedido.AdicionarItem(pedidoItem1);
            pedido.AdicionarItem(pedidoItem2);
            var voucher = new Voucher("PROMO-15-OFF", 15, null, TipoDescontoVoucher.Porcentagem, 1, DateTime.Now.AddDays(10), true, false);
        ...
        public void AplicarVoucher_DescontoExcedeValorTotalPedido_PedidoDeveTerValorZero()
        {
            ...
            var pedidoItem1 = new PedidoItem(Guid.NewGuid(), "Produto Xpto", 2, 100);
            pedido.AdicionarItem(pedidoItem1);
            var voucher = new Voucher("PROMO-15-0FF", null, 300, TipoDescontoVoucher.Valor, 1, DateTime.Now.AddDays(10), true, false);
        ...
        [Fact(DisplayName = "Aplicar Voucher Recalcular Desconto Modificação Pedido")]
        [Trait("Categoria", "Vendas - Pedido")]
