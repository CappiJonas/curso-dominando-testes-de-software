namespace Demo
{
    ...
    public class Funcionario : Pessoa
    {
        ...
        public void DefinirSalario(double salario)
        {
            ...
            Salario = salario;
            if (salario < 2000) Nivel = NivelProfissional.Junior;
            else if (salario >= 2000 && salario < 8000) Nivel = NivelProfissional.Pleno;
            else if (salario >= 8000) Nivel = NivelProfissional.Senior;
        }
